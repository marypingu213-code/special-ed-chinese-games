...
const allLessonsData = {
    ...
    "1": {
        title: "第一課：風中騎士",
        level1: [
            { word: "海", parts: ["images/L1/筆順-海-部件-1.png", "筆順-海-部件-2.png"], pos: [{x: 100, y: 180}, {x: 180, y: 180}] }
        ],
        level2: [
    ...
    "2": {
        title: "第二課：達駭黑熊",
        level1: [
            { word: "寮", parts: ["images/L2/筆順-寮-部件-1.png", "筆順-寮-部件-2.png"], pos: [{x: 120, y: 110}, {x: 120, y: 160}] },
            { word: "療", parts: ["images/L2/筆順-療-部件-1.png", "筆順-療-部件-2.png"], pos: [{x: 100, y: 120}, {x: 130, y: 150}] },
            { word: "聊", parts: ["images/L2/筆順-聊-部件-1.png", "筆順-聊-部件-2.png"], pos: [{x: 100, y: 180}, {x: 170, y: 180}] },
            { word: "骸", parts: ["images/L2/筆順-骸-部件-1.png", "筆順-骸-部件-2.png"], pos: [{x: 100, y: 180}, {x: 170, y: 180}] },
            { word: "該", parts: ["images/L2/筆順-該-部件-1.png", "筆順-該-部件-2.png"], pos: [{x: 100, y: 180}, {x: 170, y: 180}] },
            { word: "孩", parts: ["images/L2/筆順-孩-部件-1.png", "筆順-孩-部件-2.png"], pos: [{x: 100, y: 180}, {x: 170, y: 180}] },
            { word: "窩", parts: ["images/L2/筆順-窩-部件-1.png", "筆順-窩-部件-2.png"], pos: [{x: 120, y: 110}, {x: 120, y: 160}] },
            { word: "過", parts: ["images/L2/筆順-過-部件-1.png", "筆順-過-部件-2.png"], pos: [{x: 90, y: 160}, {x: 150, y: 130}] },
            { word: "奄", parts: ["images/L2/筆順-奄-部件-1.png", "筆順-奄-部件-2.png"], pos: [{x: 120, y: 110}, {x: 120, y: 160}] },
            { word: "淹", parts: ["images/L2/筆順-淹-部件-1.png", "筆順-淹-部件-2.png"], pos: [{x: 100, y: 180}, {x: 170, y: 180}] },
            { word: "煙", parts: ["images/L2/筆順-煙-部件-1.png", "筆順-煙-部件-2.png"], pos: [{x: 100, y: 180}, {x: 170, y: 180}] }
        ],
        level2: [
